  ...
  return (
    <section class="py-8">
      <div class="container px-4 mx-auto">
        <div class=" mx-auto">
          <div class="px-10 pt-6 pb-10 mb-6 border-2  border-blue-500 rounded-xl relative">
            ...
            <div class="">
              <div class="flex flex-wrap items-center justify-between -mx-4 -mb-5">
                <div class="w-full sm:w-auto ">
                  <div class="sm:flex ">
                    <img
                      class="w-[100px] h-[100px] sm:w-[200px] sm:h-[300px] mr-4 self-start rounded-xl"
                      src="https://cdn.sunpump.meme/public/logo/BOZO_TAUHnt_FBna7yj3H3Kw.gif"
                      alt=""
                    />
                    <div>
                      <h1 className="text-gray-200 text-sm sm:text-3xl font-bold mb-4">
